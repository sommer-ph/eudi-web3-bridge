...
#[derive(Parser)]
struct Args {
    /// Input file path (SHA512-mode extended recursive proof input)
    #[arg(short, long)]
    input: PathBuf,
...
struct RecursiveInputExtended {
    ...
    #[serde(rename = "headerB64")]
    header_b64: Vec<String>,
    #[serde(rename = "headerB64Length")]
    header_b64_length: String,
    #[serde(rename = "payloadB64")]
    payload_b64: Vec<String>,
    #[serde(rename = "payloadB64Length")]
    payload_b64_length: String,

    // Offsets/lengths for aligned Base64 slices used for JWK x/y extraction
    #[serde(rename = "offXB64")]
    off_x_b64: String,
    #[serde(rename = "lenXB64")]
    len_x_b64: String,
    #[serde(rename = "dropX")]
    drop_x: String,
    #[serde(rename = "lenXInner")]
    len_x_inner: String,
    #[serde(rename = "offYB64")]
    off_y_b64: String,
    #[serde(rename = "lenYB64")]
    len_y_b64: String,
    #[serde(rename = "dropY")]
    drop_y: String,
    #[serde(rename = "lenYInner")]
    len_y_inner: String,
}
...
fn main() -> Result<()> {
    ...
    println!("Converting SHA512-mode extended input to Poseidon-mode for C5 constraint");

    // Read input file
    let input_data = fs::read_to_string(&args.input)?;
    let mut input: RecursiveInputExtended = serde_json::from_str(&input_data)?;
    ...
    // Note: Extended fields (headerB64, payloadB64, etc.) remain unchanged
