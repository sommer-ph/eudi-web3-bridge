#!/usr/bin/env python3
"""
Backwards ECDSA Test Vector Generation

This script generates ECDSA test vectors by working backwards from known Circom computations.
Instead of generating a signature and hoping it works with Circom, this approach starts
with what Circom actually computes and creates compatible test data.

Purpose: Debug and understand Circom's ECDSA verification behavior by reverse-engineering
from actual circuit outputs to create working test vectors.
"""
