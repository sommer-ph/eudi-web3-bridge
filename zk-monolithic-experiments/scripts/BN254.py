...
# Kurvenparameter - FIXED for Circom compatibility
group_order = 21888242871839275222246405745257275088548364400416034343698204186575808495617  # Use scalar field r
...
def ecdsa_sign_circom_compatible(priv_key, msg_hash):
    ...
    # Strategy: Generate a signature where rx_mod == r for Circom compatibility
    max_attempts = 1000
    ...
    for attempt in range(max_attempts):
        ...
        # Check if this signature will work with Circom
...
try:
    ...
    # Ausgabe in Datei
    with open("ecdsa_input.json", "w") as f:
        json.dump(output_data, f, indent=4)

    # Verifikation
    valid = ecdsa_verify(pub_key, msg_hash, (r, s))
    print(f"✅ Daten wurden in ecdsa_input.json gespeichert. Verifikation: {valid}")
    ...
    print("✅ Fallback test vector saved to ecdsa_input.json")