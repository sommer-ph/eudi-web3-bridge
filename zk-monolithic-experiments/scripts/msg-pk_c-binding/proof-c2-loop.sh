...
###############################################################################
# zk-Proof Performance Loop – c2-with-decode (Rapidsnark Only)
###############################################################################

echo
echo "------------------------------------------------------"
echo " zk-Proof Performance Loop – c2-with-decode"
...
if [ ! -f "${BUILD_DIR}/${CIRCUIT_NAME}.zkey" ]; then
    echo "ERROR: ${BUILD_DIR}/${CIRCUIT_NAME}.zkey not found. Please run proof-c2.sh first."
    exit 1
fi

if [ ! -f "${BUILD_DIR}/${CIRCUIT_NAME}.wtns" ]; then
    echo "ERROR: ${BUILD_DIR}/${CIRCUIT_NAME}.wtns not found. Please run proof-c2.sh first."
    exit 1
fi

if [ ! -f "${BUILD_DIR}/${CIRCUIT_NAME}.vkey.json" ]; then
    echo "ERROR: ${BUILD_DIR}/${CIRCUIT_NAME}.vkey.json not found. Please run proof-c2.sh first."
    exit 1
fi
