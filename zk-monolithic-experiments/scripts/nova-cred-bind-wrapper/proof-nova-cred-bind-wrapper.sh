...
###############################################################################
# zk-Proof CLI – Nova Wrapper
###############################################################################

echo
echo "------------------------------------------------------"
echo " zk-Proof CLI – Nova Wrapper"
echo "------------------------------------------------------"
echo
...
# Paths and constants
###############################################################################
CIRCUIT_NAME="nova-cred-bind-wrapper"
BUILD_DIR="build"
INPUT_DIR="input/nova-cred-bind-wrapper"
DEST_FILE="${INPUT_DIR}/${USER_ID}-nova-cred-bind-wrapper.json"
