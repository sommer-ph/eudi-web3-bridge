...
echo
echo "------------------------------------------------------"
echo " zk-Proof CLI  EUDI Wallet Key Derivation"
echo "------------------------------------------------------"
echo
...
# Paths and constants
###############################################################################
CIRCUIT_NAME="eudi-wallet-key-derivation"
BUILD_DIR="build"
INPUT_DIR="input/cred-bind"
DEST_FILE="${INPUT_DIR}/test-eudi-wallet-key-derivation.json"
...
time_step "compile_circuit" circom "circuits/cred-bind/c1/${CIRCUIT_NAME}.circom" \
  --r1cs --wasm --sym \
